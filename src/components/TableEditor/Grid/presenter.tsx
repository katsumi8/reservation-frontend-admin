...
function GridPresenter({
  ...
  return (
    <div className="container relative mx-auto xl:max-w-[885px] max-w-[700px] overflow-scroll rounded-lg border border-gray-200 bg-white shadow-md dark:border-gray-700">
