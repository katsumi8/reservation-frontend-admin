...
const TableLayout = ({ isEditor, gridCells }: TableLayoutProp) => {
  return (
    <section
      className={
        isEditor
          ? "pointer-events-none relative grid aspect-square w-full grid-cols-15 grid-rows-15 gap-1 rounded-lg text-center font-mono text-sm font-bold leading-6 text-slate-500"
